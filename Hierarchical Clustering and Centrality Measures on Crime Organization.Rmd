...
ties <- read_excel('Edges_Ready.xlsx')
```
...
I named it graph jelly because the default algorithm will dynamically move the nodes until it converge automatically for the ‘best’ layout, and when you want to move the node, it will shake like jelly

You could check it out for yourself! all files are saved in bit.ly/ProjectDatminFaathir
...
End of Notebook
Best regards, Faathir Chikal Asyuraa